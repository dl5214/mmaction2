...
def parse_args():
    ...
    args.config = 'configs/recognition/tsn/tsn_imagenet-pretrained-r50_8xb32-1x1x8-100e_kinetics400-rgb.py'
    args.checkpoint = 'https://download.openmmlab.com/mmaction/v1.0/recognition/tsn/tsn_imagenet-pretrained-r50_8xb32-1x1x8-100e_kinetics400-rgb/tsn_imagenet-pretrained-r50_8xb32-1x1x8-100e_kinetics400-rgb_20220906-2692d16c.pth' # can be a local path
    args.video_path = '../../data/openmml/video3.mp4'
    args.label = 'tools/data/kinetics/label_map_k400.txt'
    args.device = 'cuda'  # 'cuda:0' or 'cpu'
    args.out_file = '../../data/openmml/output3.mp4'
    args.input_step = 1
    args.threshold = 0.01
    args.stride = 0
    args.cfg_options = {}
    args.label_color = (255, 255, 255)
    args.msg_color = (128, 128, 128)
    return args
